...
public class Methods {
	...
	// method.
	// It uses a for each loop and the toString() method to display all elements in
	// the object
	// array declared in the Index class.
	...
	// "mainMenu" method.
	// It makes a call to the "continueUsing" method which prompts the user for a
	// decision whether
	// to continue, or terminate the application.
	...
	public static void continueUsing() {
		...
		// and the user starts
		// again from the beginning of the application.
	...
	public static void firstNameSearch() {
		...
		// For each loop calls the "getFirstName" method from the Person class and compares
		// the returned value to user input. Matching person objects are printed to the console.
	...
	public static void lastNameSearch() {
		...
		String userIn = Index.in.next();
		// For each loop calls the "getLastName" method from the Person class and compares
		// the returned value to user input. Matching person objects are printed to the console.
		for (Person entry : Index.phoneBookArray) {
	...
	public static void telephoneNumberSearch() {
		...
		String userIn = Index.in.next();
		// For each loop calls the "getTelephoneNumber" method from the Person class and compares
		// the returned value to user input. Matching person objects are printed to the console.
		for (Person entry : Index.phoneBookArray) {
	...
	public static void addEntry() {
		...
		// Create temporary array for storing existing elements plus the new Person object.
	...
	public static void updateEntry() {
		...
		contact--;
		//Display a numbered list of Person object attributes for the user to select from.
	...
	public static void deleteEntry() {
		...
		for (@SuppressWarnings("unused") Object person : Index.phoneBookArray) {
